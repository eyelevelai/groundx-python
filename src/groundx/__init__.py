...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CustomWorkflowLeafField": ".types",
    "CustomWorkflowLeafFieldLevel": ".types",
    "CustomWorkflowLeafFieldRepetitionScope": ".types",
    "CustomWorkflowOutputMap": ".types",
    "CustomWorkflowOutputRoute": ".types",
    "CustomWorkflowOutputRouteLevel": ".types",
    "CustomWorkflowOutputRouteOutputMap": ".types",
    "CustomWorkflowStep": ".types",
    "CustomWorkflowStepConfig": ".types",
    "CustomWorkflowStepElementConfig": ".types",
    "CustomWorkflowStepKind": ".types",
    ...
    "DocumentDetailDeliveryStatus": ".types",
