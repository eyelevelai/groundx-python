...
class HealthResponseHealth(schemas.DictSchema):
    """
        ...
        class properties:
            class services(schemas.ListSchema):
                ...
                def __new__(
                    cls,
                    arg: typing.Union[
                        typing.Tuple["HealthService"], typing.List["HealthService"]
                    ],
    ...
    def __getitem__(
        self, name: typing.Union[typing_extensions.Literal["services",], str]
    ):
