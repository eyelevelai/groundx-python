...
class ProcessStatusResponseIngest(schemas.DictSchema):
    """
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["progress"]
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["progress"]
    ) -> typing.Union["ProcessStatusResponseIngestProgress", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["statusMessage"]
    ...
    def __new__(
        ...
        *args: typing.Union[
        ...
        status: "ProcessingStatus",
        progress: typing.Union[
            "ProcessStatusResponseIngestProgress", schemas.Unset
        ] = schemas.unset,
