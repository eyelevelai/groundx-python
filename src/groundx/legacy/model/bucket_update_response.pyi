...
class BucketUpdateResponse(schemas.DictSchema):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            @staticmethod
            def bucket() -> typing.Type["BucketUpdateDetail"]:
                return BucketUpdateDetail
            __annotations__ = {
                "bucket": bucket,
            }
    ...
    def __getitem__(
        self, name: typing.Union[typing_extensions.Literal["bucket",], str]
    ):
