...
class DocumentRemoteIngestRequestDocuments(schemas.ListSchema):
    """NOTE:
    ...
    def __new__(
        cls,
        arg: typing.Union[
            typing.Tuple["DocumentRemoteIngestRequestDocumentsItem"],
            typing.List["DocumentRemoteIngestRequestDocumentsItem"],
        ],
