...
class SearchResponseSearch(schemas.DictSchema):
    """
        ...
        class properties:
            ...
            class results(schemas.ListSchema):
                ...
                def __new__(
                    cls,
                    arg: typing.Union[
                        typing.Tuple["SearchResultItem"],
                        typing.List["SearchResultItem"],
                    ],
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["searchQuery"]
    ) -> MetaOapg.properties.searchQuery: ...
    @typing.overload
    def __getitem__(
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["results"]
    ) -> typing.Union[MetaOapg.properties.results, schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["query"]
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["searchQuery"]
    ) -> typing.Union[MetaOapg.properties.searchQuery, schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["text"]
    ...
    def __new__(
        ...
        *args: typing.Union[
        ...
        results: typing.Union[
            MetaOapg.properties.results, list, tuple, schemas.Unset
        ] = schemas.unset,
        query: typing.Union[
        ...
        searchQuery: typing.Union[
            MetaOapg.properties.searchQuery, str, schemas.Unset
        ] = schemas.unset,
        text: typing.Union[
