...
class DocumentResponse(schemas.DictSchema):
    """
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["document"]
    ) -> "DocumentDetail": ...
    ...
    def __getitem__(
        self, name: typing.Union[typing_extensions.Literal["document",], str]
    ):
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["document"]
    ) -> typing.Union["DocumentDetail", schemas.Unset]: ...
