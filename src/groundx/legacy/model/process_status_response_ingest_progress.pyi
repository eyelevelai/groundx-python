...
class ProcessStatusResponseIngestProgress(schemas.DictSchema):
    """
    ...
    class MetaOapg:
        class properties:
            @staticmethod
            def cancelled() -> (
                typing.Type["ProcessStatusResponseIngestProgressCancelled"]
            ):
                return ProcessStatusResponseIngestProgressCancelled

            @staticmethod
            def complete() -> (
                typing.Type["ProcessStatusResponseIngestProgressComplete"]
            ):
            ...
            @staticmethod
            def processing() -> (
                typing.Type["ProcessStatusResponseIngestProgressProcessing"]
            ):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["cancelled"]
    ) -> "ProcessStatusResponseIngestProgressCancelled": ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["complete"]
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["processing"]
    ...
    def get_item_oapg(
        ...
        "ProcessStatusResponseIngestProgressCancelled", schemas.Unset
    ]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["complete"]
    ) -> typing.Union["ProcessStatusResponseIngestProgressComplete", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["errors"]
    ) -> typing.Union["ProcessStatusResponseIngestProgressErrors", schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["processing"]
    ) -> typing.Union[
        "ProcessStatusResponseIngestProgressProcessing", schemas.Unset
    ]: ...
    @typing.overload
    def get_item_oapg(
        self, name: str
    ...
    def __new__(
        ...
        *args: typing.Union[
        ...
        cancelled: typing.Union[
            "ProcessStatusResponseIngestProgressCancelled", schemas.Unset
        ] = schemas.unset,
        complete: typing.Union[
            "ProcessStatusResponseIngestProgressComplete", schemas.Unset
        ] = schemas.unset,
        errors: typing.Union[
            "ProcessStatusResponseIngestProgressErrors", schemas.Unset
        ] = schemas.unset,
