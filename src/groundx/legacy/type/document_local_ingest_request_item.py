...
from groundx.legacy.type.document_local_ingest_request_item_metadata import (
...
class DocumentLocalIngestRequestItem(
    RequiredDocumentLocalIngestRequestItem, OptionalDocumentLocalIngestRequestItem
):
    pass
