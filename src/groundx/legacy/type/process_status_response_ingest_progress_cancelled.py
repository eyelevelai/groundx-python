...
class ProcessStatusResponseIngestProgressCancelled(
    RequiredProcessStatusResponseIngestProgressCancelled,
    OptionalProcessStatusResponseIngestProgressCancelled,
):
    pass
