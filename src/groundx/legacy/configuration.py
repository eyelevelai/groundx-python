...
from groundx.legacy.exceptions_base import ApiValueError
from groundx.legacy.exceptions import ClientConfigurationError
from groundx.legacy.exceptions import InvalidHostConfigurationError
...
class Configuration(object):
    ...
    def __init__(
        ...
        """Constructor"""
        self.host = "https://api.groundx.ai/api" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("groundx")
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "SDK Package Version: 1.3.29".format(
...
def check_url(url: str) -> str:
    ...
    if parsed.scheme not in ["http", "https"]:
        raise InvalidHostConfigurationError(
            url, 'scheme must be "http" or "https"'.format(parsed.scheme)
        )
    if parsed.netloc == "":
