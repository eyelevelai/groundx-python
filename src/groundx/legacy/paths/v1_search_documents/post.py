...
from groundx.legacy.model.search_documents_request import (
    SearchDocumentsRequest as SearchDocumentsRequestSchema,
)
from groundx.legacy.model.search_documents_request_document_ids import (
    SearchDocumentsRequestDocumentIds as SearchDocumentsRequestDocumentIdsSchema,
)
from groundx.legacy.model.search_response import SearchResponse as SearchResponseSchema

from groundx.legacy.type.search_documents_request_document_ids import (
    SearchDocumentsRequestDocumentIds,
)
from groundx.legacy.type.search_response import SearchResponse
from groundx.legacy.type.search_documents_request import SearchDocumentsRequest
...
class NSchema(schemas.IntSchema):
...
class VerbositySchema(schemas.IntSchema):
    ...
    async def _adocuments_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_search_documents_request.serialize(
                body, content_type
            )
