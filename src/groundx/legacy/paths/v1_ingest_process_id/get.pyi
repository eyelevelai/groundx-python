...
from groundx.legacy.model.process_status_response import (
    ProcessStatusResponse as ProcessStatusResponseSchema,
)

from groundx.legacy.type.process_status_response import ProcessStatusResponse
...
class BaseApi(api_client.Api):
    ...
    async def _aget_processing_status_by_id_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (request_path_process_id,):
        ...
        request_before_hook(
            ...
            path_template="/v1/ingest/{processId}",
            auth_settings=_auth,
            headers=_headers,
        )
