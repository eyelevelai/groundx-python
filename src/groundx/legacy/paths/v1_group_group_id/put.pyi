...
from groundx.legacy.model.group_response import GroupResponse as GroupResponseSchema
from groundx.legacy.model.group_update_request import (
    GroupUpdateRequest as GroupUpdateRequestSchema,
)

from groundx.legacy.type.group_response import GroupResponse
from groundx.legacy.type.group_update_request import GroupUpdateRequest
...
# body param
SchemaForRequestBodyApplicationJson = GroupUpdateRequestSchema

request_body_group_update_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (request_path_group_id,):
        ...
        request_before_hook(
            ...
            path_template="/v1/group/{groupId}",
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_group_update_request.serialize(
            body, content_type
        )
