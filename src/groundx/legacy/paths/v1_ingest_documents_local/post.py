...
from groundx.legacy.model.document_local_ingest_request import (
    DocumentLocalIngestRequest as DocumentLocalIngestRequestSchema,
)

from groundx.legacy.type.document_local_ingest_request import DocumentLocalIngestRequest
    ...
    async def _aingest_local_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_document_local_ingest_request.serialize(
                body, content_type
            )
