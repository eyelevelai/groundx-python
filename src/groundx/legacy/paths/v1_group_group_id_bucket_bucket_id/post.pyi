...
class AddBucket(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_bucket(
        self,
        group_id: int,
        bucket_id: int,
        **kwargs,
        ...
        return await self._aadd_bucket_oapg(
