...
from groundx.legacy.model.message_response import (
    MessageResponse as MessageResponseSchema,
)

from groundx.legacy.type.message_response import MessageResponse
...
class BaseApi(api_client.Api):
    def _remove_bucket_mapped_args(
        self,
        group_id: int,
        bucket_id: int,
    ...
    async def _aremove_bucket_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template="/v1/group/{groupId}/bucket/{bucketId}",
            auth_settings=_auth,
            headers=_headers,
        )
...
class RemoveBucket(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_bucket(
        self,
        group_id: int,
        bucket_id: int,
        **kwargs,
        ...
        return await self._aremove_bucket_oapg(
    ...
    def remove_bucket(
        ...
        return self._remove_bucket_oapg(
            path_params=args.path,
        )
