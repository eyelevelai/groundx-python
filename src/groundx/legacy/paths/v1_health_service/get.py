...
from groundx.legacy.model.health_response import HealthResponse as HealthResponseSchema

from groundx.legacy.type.health_response import HealthResponse
...
class BaseApi(api_client.Api):
    ...
    async def _aget_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (request_path_service,):
        ...
        request_before_hook(
            ...
            path_template="/v1/health/{service}",
            auth_settings=_auth,
            headers=_headers,
        )
