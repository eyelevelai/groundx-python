...
from groundx.legacy.model.document_response import (
    DocumentResponse as DocumentResponseSchema,
)

from groundx.legacy.type.document_response import DocumentResponse
...
SchemaFor200ResponseBodyApplicationJson = DocumentResponseSchema
...
class BaseApi(api_client.Api):
    ...
    async def _aget_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (request_path_document_id,):
        ...
        request_before_hook(
            ...
            path_template="/v1/ingest/document/{documentId}",
            auth_settings=_auth,
            headers=_headers,
        )
