...
from groundx.legacy.model.website_crawl_request import (
    WebsiteCrawlRequest as WebsiteCrawlRequestSchema,
)
from groundx.legacy.model.website_crawl_request_websites import (
    WebsiteCrawlRequestWebsites as WebsiteCrawlRequestWebsitesSchema,
)

from groundx.legacy.type.website_crawl_request_websites import (
    WebsiteCrawlRequestWebsites,
)
from groundx.legacy.type.website_crawl_request import WebsiteCrawlRequest
    ...
    async def _acrawl_website_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_website_crawl_request.serialize(
                body, content_type
            )
