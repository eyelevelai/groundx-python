...
from groundx.legacy.model.bucket_update_response import (
    BucketUpdateResponse as BucketUpdateResponseSchema,
)
from groundx.legacy.model.bucket_update_request import (
    BucketUpdateRequest as BucketUpdateRequestSchema,
)

from groundx.legacy.type.bucket_update_request import BucketUpdateRequest
from groundx.legacy.type.bucket_update_response import BucketUpdateResponse
...
# body param
SchemaForRequestBodyApplicationJson = BucketUpdateRequestSchema

request_body_bucket_update_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (request_path_bucket_id,):
        ...
        request_before_hook(
            ...
            path_template="/v1/bucket/{bucketId}",
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_bucket_update_request.serialize(
            body, content_type
        )
