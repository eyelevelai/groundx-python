...
from groundx.legacy.model.group_create_request import (
    GroupCreateRequest as GroupCreateRequestSchema,
)

from groundx.legacy.type.group_create_request import GroupCreateRequest
from groundx.legacy.type.group_response import GroupResponse

from . import path

# body param
SchemaForRequestBodyApplicationJson = GroupCreateRequestSchema


request_body_group_create_request = api_client.RequestBody(
    content={
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template="/v1/group",
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_group_create_request.serialize(
            body, content_type
        )
