...
from groundx.legacy.model.ingest_response import IngestResponse as IngestResponseSchema
from groundx.legacy.model.document_remote_ingest_request_documents import (
    DocumentRemoteIngestRequestDocuments as DocumentRemoteIngestRequestDocumentsSchema,
)
from groundx.legacy.model.document_remote_ingest_request import (
    DocumentRemoteIngestRequest as DocumentRemoteIngestRequestSchema,
)

from groundx.legacy.type.document_remote_ingest_request import (
    DocumentRemoteIngestRequest,
)
from groundx.legacy.type.document_remote_ingest_request_documents import (
    DocumentRemoteIngestRequestDocuments,
)
from groundx.legacy.type.ingest_response import IngestResponse
    ...
    async def _aingest_remote_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template="/v1/ingest/documents/remote",
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_document_remote_ingest_request.serialize(
                body, content_type
            )
