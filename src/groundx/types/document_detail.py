...
class DocumentDetail(UniversalBaseModel):
    ...
    """
    Document creation time in RFC 3339 format, when available.
    """

    delivery_status: typing_extensions.Annotated[
        typing.Optional[DocumentDetailDeliveryStatus],
        FieldMetadata(alias="deliveryStatus"),
        pydantic.Field(
            alias="deliveryStatus",
            description="Current-run required customer delivery confirmation. Failed confirmation does not prove nonreceipt; unknown means saved evidence is insufficient.",
        ),
    ] = None
    ...
    extraction_ready: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="extractionReady"),
        pydantic.Field(
            alias="extractionReady",
            description="Whether the current run's final extraction is published after required review and transformations. Null means saved evidence is insufficient.",
        ),
    ] = None
    ...
    hosted_source_url: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="hostedSourceUrl"),
        pydantic.Field(
            alias="hostedSourceUrl",
            description="GroundX-hosted stored source URL, when available. Returned by document detail only; access still requires normal document authorization.",
        ),
    ] = None
