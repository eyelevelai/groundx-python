...
class Document(UniversalBaseModel):
    bucket_id: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="bucketId", description="The bucketId of the bucket which this file will be ingested into."
        ),
    ]
    ...
    file_path: typing_extensions.Annotated[
        str,
        FieldMetadata(alias="filePath"),
        pydantic.Field(
            alias="filePath", description="The local file path or remote URL of the document being ingested by GroundX."
        ),
    ]
