...
class GroundX:
    ...
    environment : GroundXIngestEnvironment
        The environment to use for requests from the client. from .environment import GroundXIngestEnvironment



        Defaults to GroundXIngestEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: GroundXIngestEnvironment = GroundXIngestEnvironment.DEFAULT,
        api_key: str,
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: GroundXIngestEnvironment) -> str:
