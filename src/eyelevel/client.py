...
class EyeLevel:
    ...
    environment : EyeLevelEnvironment
        The environment to use for requests from the client. from .environment import EyeLevelEnvironment



        Defaults to EyeLevelEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: EyeLevelEnvironment = EyeLevelEnvironment.DEFAULT,
        api_key: str,
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: EyeLevelEnvironment) -> str:
