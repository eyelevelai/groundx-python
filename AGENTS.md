...
| [Extraction boundary fixtures](tests/extract/fixtures/extraction-boundary/README.md) | Fixture capture, review, promotion, and certification follow the canonical private Studio Harness certification guide (`groundx-extraction-workflows` skill, `references/certification.private.md`). |
