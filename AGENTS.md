...
`reference.md` (3700+ lines) is also generated and should not be edited by hand.
...
3. **Decide the import surface.** Users will import via
   ...
   submodule's symbols.
4. **Follow the collocated test convention for now** (matching extract); test layout
   for hand-written submodules may be reconciled later.
