# workflow-template-config Specification

## Purpose
Define the shipped workflow-level `template` contract across the backend API,
Fern-generated SDKs, and optional downstream harness YAML passthrough.
