...
- [ ] 1.1 Parametrize the exact-kwargs test in `tests/extract/services/test_status.py` (renamed
...
- [ ] 2.1 In `Status.__init__` (`src/groundx/extract/services/status.py`), replace the
      ...
      check: poetry run pytest "tests/extract/services/test_status.py::test_status_redis_client_derives_connection_params_from_broker_url" -q
- [ ] 2.2 Run the full `tests/extract/services/test_status.py` file to confirm the other `Status`
