...
- The SDK package version containing `prepare_extraction_yaml()` must be
  confirmed before harness templates depend on it.
...
- Public docs publish/preview:
  `/Users/benjaminfletcher/git/eyelevel-fern-config/openspec/changes/publish-structured-extraction-workflow/tasks.md`
