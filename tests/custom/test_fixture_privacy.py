...
@pytest.mark.parametrize(
    ("name", "payload"),
    [
        ("tax identifier", {"tax_identification_number": "12-3456789"}),
        ("account number", {"account_number": "00000000-0"}),
        ("live ID", {"documentID": "00000000-0000-4000-8000-000000000000"}),
...
def test_private_yaml_values_are_rejected(tmp_path: pathlib.Path) -> None:
    ...
    path.write_text("account_number: 00000000-0\n", encoding="utf-8")
